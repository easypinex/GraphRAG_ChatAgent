...
from langchain_experimental.graph_transformers.llm import _Graph, optional_enum_field, system_prompt
from langchain_core.prompts import ChatPromptTemplate
from pydantic import BaseModel, Field, create_model

from logger.logger import get_logger
from prompts.prompts import CHUNK_TO_ENTITY_AND_RELATIONSHIP_PROMPT

logging = get_logger()

class TwlfLlmGraphTransformer(LLMGraphTransformer):
    '''
    ...
    def __init__(self, **kwargs):
        ...
        prompt = prompt or CHUNK_TO_ENTITY_AND_RELATIONSHIP_PROMPT # 新增使用繁體中文回應問題
